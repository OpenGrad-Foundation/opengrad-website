...
import { AdvisorsTableColumns } from "./services/tableColumn";
import AddAdvisorsModal from "./components/addAdvisorsModal";
import toast from "react-hot-toast";
import UpdateAdvisorsModal from "./components/UpdateAdvisorsModal";

const OurAdvisorsAdmin = () => {
  ...
  const handleDelete = async () => {
    if (selectedItem) {
      ...
      if (error) {
        toast.error(`Error deleting ouradvisors: ${error.message}`);
        console.error("Delete error:", error.message);
      } else {
        toast.success("ouradvisors deleted successfully!");
...
export default OurAdvisorsAdmin;
