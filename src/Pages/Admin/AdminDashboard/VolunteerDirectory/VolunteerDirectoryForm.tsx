...
import { insertVolunteers, updateVolunteers } from "./services/apis";

type Props = {
  showAddForm: boolean;
  close: React.Dispatch<React.SetStateAction<boolean>>;
  initialData?: VolunteerType;
  tablename: string;
};

export const VolunteerDirectoryForm = ({
  showAddForm,
  close,
  initialData,
  tablename,
 ...
 const handleAddFormSubmit = async (e: React.FormEvent) => {
   ...
   try {
     if (initialData?.id) {
       ...
       const response = await updateVolunteers(
         formData,
         initialData.id,
         tablename
       );
       ...
       const response = await insertVolunteers(formData, tablename);
       if (response) {
