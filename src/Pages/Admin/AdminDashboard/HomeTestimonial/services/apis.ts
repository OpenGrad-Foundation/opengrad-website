...
export const getTestimonial = async (
  ...
  try {
    ...
    toast.error("Error fetching home testimonial");
    throw error;
  }
};

export const insertTestimonial = async (formdata: any, tablename: string) => {
  const adjustedData = {
...
export const updateTestimonial = async (formdata: any, id: string, tablename: string) => {
  const adjustedData = {
    description: formdata.description,
    created_at: formattedDateAndTime,
    image: formdata.image,
...
export const handleDeleteDetails = async (id: string, imagePath: string, tablename: string) => {
  try {
    ...
    if (deleteTestimonialError) {
      toast.error("Error deleting testimonial from database");
