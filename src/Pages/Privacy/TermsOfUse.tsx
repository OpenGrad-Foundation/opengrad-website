...
export const TermsOfUse = (_props: Props) => {
  ...
  return (
    <div className={styles.Wrapper}>
      ...
      <div className={styles.inner}>
        ...
        <p>
          We are OpenGrad Edu Foundation ('<b>Company</b>', '<b>we</b>', '
          <b>us</b>', or '<b>our</b>'), a company registered in India at
          2/400/B, Firdouse House, Near East Block of NIT,Chathamangalam,
          Kozhikode, Kerala 673601.
        </p>

        <p>
          We operate the website{" "}
          <a href="https://opengrad.in/">https://opengrad.in/</a> (the '
          <b>Site</b>
          '), the mobile application OpenGrad Foundation (the ' <b>App</b>'), as
          well as any other related products and services that refer or link to
          these legal terms (the '<b>Legal Terms</b>') (collectively, the '
          <b>Services</b>').
        </p>
        <p>
          Opengrad Foundation is a non-profit organization making elite college
          education accessible to everyone in India. We provide free coaching
          for entrance exams to top colleges, focusing on those facing barriers
          to higher education, especially from underprivileged communities. Our
          platform offers video classes, mock tests, and personalized support,
          with a strong community of volunteers and mentors.
        </p>
        <p>
          You can contact us by phone at 08714823928, email at
          admin@opengrad.in, or by mail to 2/400/B, Firdouse House, Near East
          Block of NIT,Chathamangalam, Kozhikode, Kerala 673601, India.
        </p>
        <p>
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ('you'), and
          OpenGrad Edu Foundation, concerning your access to and use of the
        ...
        <p>
          ...
          upon posting or notifying you by admin@opengrad.in, as stated in the
        ...
        <div className={styles.tableOfContents}>
          ...
          <table className={styles.table}>
            <tbody>
              <tr onClick={() => scrollToSection("services")}>
                <td>1. Our Services</td>
              </tr>
              <tr onClick={() => scrollToSection("ip-rights")}>
                <td>2. Intellectual Property Rights</td>
              </tr>
              <tr onClick={() => scrollToSection("user-representations")}>
                <td>3. User Representations</td>
              </tr>
              <tr onClick={() => scrollToSection("user-registration")}>
                <td>4. User Registration</td>
              </tr>
              <tr onClick={() => scrollToSection("purchases-payment")}>
                <td>5. Purchases and Payment</td>
              </tr>
              <tr onClick={() => scrollToSection("prohibited-activities")}>
                <td>6. Prohibited Activities</td>
              </tr>
              <tr onClick={() => scrollToSection("user-generated")}>
                <td>7. User Generated Contributions</td>
              </tr>
              <tr onClick={() => scrollToSection("contribution-license")}>
                <td>8. Contribution License</td>
              </tr>
              <tr onClick={() => scrollToSection("reviews-guidelines")}>
                <td>9. Guidelines for Reviews</td>
              </tr>
              <tr onClick={() => scrollToSection("app-license")}>
                <td>10. Mobile Application License</td>
              </tr>
              <tr onClick={() => scrollToSection("third-party-websites")}>
                <td>11. Third-Party Websites and Content</td>
              </tr>
              <tr onClick={() => scrollToSection("services-management")}>
                <td>12. Services Management</td>
              </tr>
              <tr onClick={() => scrollToSection("privacy-policy")}>
                <td>13. Privacy Policy</td>
              </tr>
              <tr onClick={() => scrollToSection("copyright-infringements")}>
                <td>14. Copyright Infringements</td>
              </tr>
              <tr onClick={() => scrollToSection("term-termination")}>
                <td>15. Term and Termination</td>
              </tr>
              <tr onClick={() => scrollToSection("modifications")}>
                <td>16. Modifications and Interruptions</td>
              </tr>
              <tr onClick={() => scrollToSection("governing-law")}>
                <td>17. Governing Law</td>
              </tr>
              <tr onClick={() => scrollToSection("dispute-resolution")}>
                <td>18. Dispute Resolution</td>
              </tr>
              <tr onClick={() => scrollToSection("corrections")}>
                <td>19. Corrections</td>
              </tr>
              <tr onClick={() => scrollToSection("disclaimer")}>
                <td>20. Disclaimer</td>
              </tr>
              <tr onClick={() => scrollToSection("limitations")}>
                <td>21. Limitations of Liability</td>
              </tr>
              <tr onClick={() => scrollToSection("indemnification")}>
                <td>22. Indemnification</td>
              </tr>
              <tr onClick={() => scrollToSection("user-data")}>
                <td>23. User Data</td>
              </tr>
              <tr onClick={() => scrollToSection("electronic-comms")}>
                <td>
                  24. Electronic Communications, Transactions, and Signatures
                </td>
              </tr>
              <tr onClick={() => scrollToSection("miscellaneous")}>
                <td>25. Miscellaneous</td>
              </tr>
              <tr onClick={() => scrollToSection("community-guidelines")}>
                <td>26. Community Guidelines</td>
              </tr>
              <tr onClick={() => scrollToSection("contact-us")}>
                <td>27. Contact Us</td>
              </tr>
            </tbody>
          </table>
        ...
        <div className={styles.termsContent}>
          ...
          <section id="ip-rights">
            ...
            <p>
              ...
              <b onClick={() => scrollToSection("prohibited-activities")}>
            ...
            <p>
              ...
              Terms, please address your request to: admin@opengrad.in. If we
            ...
            <p>
              ...
              your Contributions, and to sublicence the licences granted in this
            ...
            <p>
              ...
              us Submissions and/or posting Contributions through any part of
            ...
            <p>
              ...
              immediately refer to the '<b>COPYRIGHT INFRINGEMENTS</b>' section
              below.
            </p>
          </section>
          ...
          <section id="user-representations">
            ...
            <p>
              ...
              (7) you will not use the Services for any illegal or unauthorised
          ...
          <section id="purchases-payment">
            ...
            <p>
              ...
              purchases and any applicable shipping fees, and you authorise us
            ...
            <p>
              ...
              limit or prohibit orders that, in our sole judgement, appear to be
          ...
          <section id="contribution-license">
            ...
            <p>
              ...
              re-categorise any Contributions to place them in more appropriate
          ...
          <section id="reviews-guidelines">
            ...
            <p>
              ...
              statements; and (8) you may not organise a campaign encouraging
          ...
          <section id="app-license">
            ...
            <p>
              ...
              to access the Services: (1) the licence granted to you for our App
              is limited to a non-transferable licence to use the application on
              a device that utilises the Apple iOS or Android operating systems,
              ...
              agreement when using the App, e.g. if you have a VoIP application,
              ...
              terms and conditions in this mobile application licence contained
              in these Legal Terms, and that each App Distributor will have the
          ...
          <section id="privacy-policy">
            ...
            <p>
              ...
              Policy: <b>opengrad.in/privacy-policy</b>. By using the Services,
              you agree to be bound by our Privacy Policy, which is incorporated
              into these Legal Terms. Please be advised the Services are hosted
              in India. If you access the Services from any other region of the
          ...
          <section id="governing-law">
            ...
            <p>
              ...
              laws of India. OpenGrad Edu Foundation and yourself irrevocably
          ...
          <section id="dispute-resolution">
            ...
            <p>
              ...
              place, or arbitration shall be Kozhikode, India. The language of
          ...
          <section id="indemnification">
            ...
            <p>
              ...
              and you agree to cooperate, at your expense, with our defence of
          ...
          <section id="miscellaneous">
            ...
            <p>
              ...
              and all defences you may have based on the electronic form of
          ...
          <section id="community-guidelines">
            <h2>26. Community Guidelines</h2>
            <p>
              Welcome to the Opengrad Foundation community! We're committed to
              making elite college education accessible to everyone in India. To
              ensure a positive and productive environment for all, please
              adhere to the following guidelines: 1. Respect and Inclusivity
              Treat all community members with respect, regardless of their
              background, education level, or social status. Embrace diversity
              and promote inclusivity in all interactions. Avoid any form of
              discrimination, harassment, or hate speech. 2. Collaborative
              Learning Encourage a supportive learning environment where members
              help each other grow. Share knowledge and resources generously,
              aligning with our open-source mindset. Respect intellectual
              property rights and give credit where it's due. 3. Honest and
              Ethical Behavior Maintain academic integrity in all aspects of
              your participation. Do not engage in or promote cheating,
              plagiarism, or any form of academic dishonesty. Be truthful about
              your qualifications and experiences. 4. Constructive Communication
              Provide feedback and criticism in a constructive and respectful
              manner. Stay on-topic in discussions and avoid spamming or
              excessive self-promotion. Use appropriate language and tone in all
              communications. 5. Privacy and Confidentiality Respect the privacy
              of other community members. Do not share personal information of
              others without their explicit consent. Maintain the
              confidentiality of any sensitive information shared within the
              community. 6. Responsible Resource Use Use the provided resources
              (video lectures, practice questions, mock tests) responsibly. Do
              not distribute or share access to Opengrad's resources outside the
              community without permission. 7. Active Participation Actively
              engage in community activities and discussions. Honor your
              commitments, whether as a student, volunteer, or mentor. Report
              any violations of these guidelines to the Opengrad administration.
              8. Continuous Improvement Be open to feedback and willing to learn
              from others. Contribute to the improvement of Opengrad's programs
              and resources when possible. Share your success stories to inspire
              and motivate others in the community. 9. Technology Use Use the
              Opengrad platform and app responsibly. Report any technical issues
              or bugs to help improve the user experience. Do not attempt to
              compromise the security or integrity of the platform. 10.
              Representation When representing Opengrad in any capacity, uphold
              the organization's values and mission. Seek permission before
              using Opengrad's name or logo for any external purposes. Failure
              to adhere to these guidelines may result in warnings or, in severe
              cases, removal from the Opengrad community. We believe in second
              chances and education, so minor infractions will be addressed with
              guidance and support. Remember, we're all here to learn, grow, and
              uplift each other. By following these guidelines, you're
              contributing to a positive community that empowers everyone to
              achieve their educational dreams. For any questions or concerns
              about these guidelines, please contact admin@opengrad.in.
            </p>
          </section>
          ...
          <section id="contact-us">
            ...
            <b>
              ...
              <br />
              Near East Block of NIT,Chathamangalam
              <br />
              Kozhikode, Kerala 673601
              <br />
              India
              ...
              Phone: 08714823928
              <br />
              <a href="mailto:admin@opengrad.in">admin@opengrad.in</a>
            </b>
          </section>
        </div>
      </div>
