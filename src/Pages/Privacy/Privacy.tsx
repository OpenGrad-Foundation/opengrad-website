...
export const Privacy = (_props: Props) => {
  return (
    <div className={styles.Wrapper}>
      <Navbar />
      <div className={styles.inner}>
        <h1>Privacy Policy for Opengrad Foundation</h1>
        ...
        <ul>
          ...
          <li>
            ...
            "Our" in this Agreement) refers to Opengrad Edu Foundation, 2/400/B,
            Firdouse House, Kozhikode-673601.
          </li>
          <li>
          ...
          <li>
            <b>Country</b> refers to: Kerala, India
          </li>
          <li>
          ...
          <li>
            <b>Website</b> refers to Opengrad Foundation, accessible from&nbsp;
            <a href="https://opengrad.in/">https://opengrad.in/</a>
          </li>
          <li>
        ...
        <ul>
          <li>
            By email: <a href="mailto:admin@opengrad.in">admin@opengrad.in</a>
          </li>
        </ul>
